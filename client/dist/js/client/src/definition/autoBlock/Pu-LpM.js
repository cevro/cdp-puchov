...
const Signals_1 = require("../../components/definitions/Signals");
const autoBlockSectors = [
    { locoNetId: 700 },
    { locoNetId: 701 },
    { locoNetId: 702 },
    { locoNetId: 703 },
...
const signals = [
    {
        name: '1S',
        locoNetId: 517,
        type: Signals_1.SignalTypes.TYPE_ENTRY,
        lights: ['HZ', 'Z', 'C', 'B', 'DZ'],
        SVGData: {
            rotate: 180,
            x: 100,
    ...
    },
    {
        name: '1-22',
        locoNetId: 515,
        type: Signals_1.SignalTypes.TYPE_AB,
        lights: ['HZ', 'Z', 'C'],
        SVGData: {
            rotate: 180,
            x: 250,
...
//# sourceMappingURL=Pu-LpM.js.map