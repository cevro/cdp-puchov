...
var Sector = (function (_super) {
    ...
    Sector.prototype.render = function () {
        ...
        return (React.createElement("g", { className: busy ? 'busy' : 'free', transform: 'translate(' + data.px + ',' + data.py + ')' }, data.points.map(function (points, index) {
